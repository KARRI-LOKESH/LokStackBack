"""
Django settings for lokstackback project.
...
SECRET_KEY = 'django-insecure-4vm0%dcdndl$w#1&k3lz2kct+_k*m)hi67^+u5zx$%--ffpn_5'
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'lokstackback.onrender.com', 
    'lok-stack.vercel.app',# <-- add this line
]
...
WSGI_APPLICATION = 'lokstackback.wsgi.application'
